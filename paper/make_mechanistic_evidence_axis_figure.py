...
def build_figure(output:Path=OUT)->Path:
    ...
    ax.set_title('Biological proximity and identification strength are distinct dimensions')
    ax.grid(True,linewidth=0.5,alpha=0.35)
    fig.text(0.5,0.01,'Illustrative positions only; no monotone relation or statistical independence is assumed.',ha='center',fontsize=8.5)
