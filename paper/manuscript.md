...
The argument belongs to established traditions of structural identifiability and partial identification. We do not claim new identifiability algebra. The contribution is ecological and evidentiary: to add an explicit identification dimension to mechanistic evidence, make that distinction exact for a recurring ecological observation class, and carry the resulting information boundaries through sensitivity analysis to field-design and reporting consequences.
